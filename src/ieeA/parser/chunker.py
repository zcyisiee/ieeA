"""
DEPRECATED: This module is not currently used.
The main parser is latex_parser.py which uses regex-based parsing.
This module uses pylatexenc for AST-based parsing and may be used in future.
"""

import warnings

warnings.warn(
    "chunker module is deprecated, use latex_parser instead",
    DeprecationWarning,
    stacklevel=2,
)
...
class LatexChunker:
    ...
    # or preserved as-is.
    INLINE_PROTECTED_MACROS = {"cite", "ref", "eqref", "label", "url", "href", "code"}
